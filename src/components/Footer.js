        ...
        <StaticQuery
            ...
            render={({ FooterLogo }) => (
                <div className="bg-blue-900 text-white text-center mt-12 py-16 relative">
                    ...
                    <p className="font-sans text-xs pt-2">Realizado por <a href="https://github.com/thecodingfamilyes" title="The Coding Family" className="font-bold">The Coding Family</a></p>
