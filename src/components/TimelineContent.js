                ...
                <TimelineContainer>
                    <TimelineItem
                        ...
                        <div className="item-content py-4">
                            ...
                            <div>
                                <p>
                                    {t('Os recomendamos que si queréis asistir a una ceremonia mágica, de la mano del Padre Siluan Sandor, no dejéis de venir, os va a gustar y más a nosotros el poder contar con vuestra presencia en el templo ;) .')}
                                </p>
                            </div>

                            <div className="flex-1 flex justify-center">
                                <div className="w-full mt-4">
                                    <Image {...FotoIglesia.childImageSharp}/>
                                </div>
                            </div>
                        </div>
                    </TimelineItem>
                    ...
                    <TimelineItem
                        ...
                        <div className="item-content py-4">
                            ...
                            <div className="flex-1 flex justify-center">
                                <div className="w-full mt-4">
                                    <Image {...FotoCopaEspera.childImageSharp}/>
                                </div>
                            </div>
                        </div>
                    </TimelineItem>
                    ...
                    <TimelineItem
                        ...
                        <div className="item-content py-4">
                            <div className="flex">
                                <div className="flex-1">
                                    <p>
                                        {t('Aquí es donde aparecemos nosotros, disfrutaréis de toda clase de “picoteo”, eso sí, reservaros un poquito para el banquete, que queda mucha comida por delante!!!')}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex-1 flex justify-center">
                                <div className="w-full mt-4">
                                    <Image {...FotoCoctel.childImageSharp}/>
                                </div>
                            </div>
                        </div>
                    </TimelineItem>
                    ...
                    <TimelineItem
                        ...
                        <div className="item-content py-4">
                            <div className="flex">
                                <div className="flex-1">
                                    <p>
                                        {t('Os invitamos a un banquete muy activo donde cada uno de vosotros tiene un papel importante para que la diversión esté asegurada en todo momento.')}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex-1 flex justify-center">
                                <div className="w-full mt-4">
                                    <Image {...FotoBanquete.childImageSharp}/>
                                </div>
                            </div>
                        </div>
                    </TimelineItem>
                    ...
                    <TimelineItem
                        ...
                        <div className="item-content py-4">
                            <div className="flex">
                                <div className="flex-1">
                                    <p>
                                        {t('La apertura de baile estará de nuestra mano pero una vez hayamos finalizado seréis vosotros los encargados de continuar la fiesta, dándolo todo ya que no faltará música variada, sorpresas y buen ambiente.')}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex-1 flex justify-center">
                                <div className="w-full mt-4">
                                    <Image {...FotoFiesta.childImageSharp}/>
                                </div>
                            </div>
                        </div>
                    </TimelineItem>
